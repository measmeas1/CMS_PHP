...
<body class="sb-nav-fixed">
  <nav class="navbar navbar-dark navbar-expand bg-dark sb-topnav">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="post_table.php">Posts Table</a>
    <!-- Sidebar Toggle-->
    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          <h1 class="mt-4">All Posts Record</h1>
                ...
                <tbody>
                  <tr>
                    ...
                    ?>
                      ...
                      <td><?php echo $date ?></td>
                      <td><?php echo $user_row['name'] ?? 'User Delete!' ?></td>
                      ...
                      <td>
                        <div class="d-flex my-2">
                          ...
                          <?php if (isset($_SESSION['is_admin']) && $_SESSION['is_admin'] == 1 || $p_id == $_SESSION['id']) { ?>
                            <a href="delete_post.php?id=<?php echo $id; ?>" class="btn btn-action btn-danger btn-sm ms-1" onclick="return confirm('Are you sure?');">
                              <i class="fa-trash fas"></i>
                            </a>
                            <?php } ?>
                            <?php if($p_id == $_SESSION['id']){ ?>
